...
export const ServiceMap: Map<string, Service> = new Map([
  ...
  [C.RUNTIME_BASE58TOADDRESS_NAME, { execute: Runtime.runtimeBase58ToAddress }],
  [C.RUNTIME_ADDRESSTOBASE58_NAME, { execute: Runtime.runtimeAddressToBase58 }],
  [C.RUNTIME_GETRANDOMHASH_NAME, { execute: Runtime.runtimeGetRandomHash }],
