...
describe('Long encoding test', () => {
  test('Long encoding', async () => {
    ...
    expect(bigIntToBytes(Long.fromString('-8380656'))).toEqual(new Buffer([16, 31, 128]));

    expect(bigIntToBytes(Long.fromString('8380656'))).toEqual(new Buffer([240, 224, 127]));

    expect(bigIntToBytes(Long.fromString('-8446192'))).toEqual(new Buffer([16, 31, 127, 255]));

    expect(bigIntToBytes(Long.fromString('8446192'))).toEqual(new Buffer([240, 224, 128, 0]));
